...
User.belongsToMany(Group, { through: GroupParticipant, foreignKey: "tenantId", as: "groups" });
...
module.exports = { User, Property, PropertyImage, Group, GroupParticipant, Conversation, Participant, Message, Profile, Expense, Chore };